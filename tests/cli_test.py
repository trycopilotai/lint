...
class FormattingTest(unittest.TestCase):
    ...
    def test_install_commands_are_runnable_formatter_recovery_steps(self) -> None:
        expected = {
            ...
            "java": "docker pull ghcr.io/trycopilotai/lint-java:0.1.5",
            "go": "docker pull ghcr.io/trycopilotai/lint-go:0.1.5",
            "rust": "rustup toolchain install 1.97.1 --component rustfmt",
            "kotlin": "docker pull ghcr.io/trycopilotai/lint-kotlin:0.1.5",
            "toml": "cargo install taplo-cli --version 0.10.0 --locked",
            "xml": "docker pull ghcr.io/trycopilotai/lint-xml:0.1.5",
            "swift": "docker pull ghcr.io/trycopilotai/lint-swift:0.1.5",
            "csharp": "dotnet tool install --global csharpier --version 1.3.0",
            "julia": "docker pull ghcr.io/trycopilotai/lint-julia:0.1.5",
        }
        languages_by_family = {}
        for language in LINT.load_languages():
