...
class ReleaseProvenanceTest(unittest.TestCase):
    ...
    def test_statement_binds_source_manifest_images_and_controller(self) -> None:
        ...
        self.assertEqual(
            ...
            subjects["lint-0.1.7.tar.gz"]["sha256"],
        )
        self.assertEqual(
            manifest_digest,
            subjects["release-manifest-0.1.7.json"]["sha256"],
        )
        self.assertEqual(
            "1" * 64,
